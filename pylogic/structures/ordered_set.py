...
class OrderedSet(Set):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.order_is_transitive = OrderedSet.property_order_is_transitive(
            self, self.total_order
        )
        self.order_is_transitive._set_is_axiom(True)
        self.order_is_antisymmetric = OrderedSet.property_order_is_antisymmetric(
            self, self.total_order
        )
        self.order_is_antisymmetric._set_is_axiom(True)
        self.order_is_strongly_connected = (
            OrderedSet.property_order_is_strongly_connected(self, self.total_order)
        )
        self.order_is_strongly_connected._set_is_axiom(True)

        self.order_definition = OrderedSet.property_order_definition(
            self, self.total_order, self.strict_total_order
        )
        self.order_definition._set_is_axiom(True)
        self.strict_order_definition = OrderedSet.property_strict_order_definition(
            self, self.total_order, self.strict_total_order
        )
