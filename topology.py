...
def forall_finite_collections_of(a, prop):
...
def forall_collections_of(a, prop):
    return ForallInSet(c1, AllSequences, (ForallInSet(n, Naturals, c1[n].is_in(a))).implies(prop(c1)))
